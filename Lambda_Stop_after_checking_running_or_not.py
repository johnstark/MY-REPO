...
def lambda_handler(event, context):
	...
	url='https://s3-us-west-2.amazonaws.com/vss-devops-support/Vasanth/Auto+Start-Stop/Titans.csv'
	...
	if count_a != 0:
			a = "\n The following instances are stopped successfully: \n"+mystring_1
	else:
			a = "\n All the instances are in stopped state \n"
	if count_b != 0:
